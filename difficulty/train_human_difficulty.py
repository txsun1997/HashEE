...
from analysis.modeling_bert import BertForSequenceClassification
...
def parse_args():
    ...
    parser.add_argument("--data_dir", default="./snli_human_difficulty", type=str)
...
if __name__ == '__main__':
    ...
    trainer = Trainer(train_data=train_data, model=model, loss=LossInForward(), optimizer=optimizer, batch_size=32,
                      ...
                      num_workers=4, n_epochs=args.n_epochs, print_every=5, dev_data=train_data, metrics=metric,
