...
from analysis.modeling_bert import BertForLinearBMultiLabelSequenceClassification
...
if __name__ == '__main__':
    ...
    model = BertForMultiLabelSequenceClassification.from_pretrained(args.model_name_or_path, config=config)
