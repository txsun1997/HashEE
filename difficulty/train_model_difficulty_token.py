...
from analysis.modeling_bert import BertForMultiLabelTokenClassification, BertForLinearBMultiLabelTokenClassification
...
if __name__ == '__main__':
    ...
    model = BertForLinearBMultiLabelTokenClassification.from_pretrained(args.model_name_or_path, config=config)
    ...
    test_data.set_input('input_ids', 'attention_mask', 'labels')
